...
export function DoctorsDeleteDialog({
  ...
  const doctorInfo = `${currentRow.specialization ? `${currentRow.specialization} - ` : ''}${currentRow.department || 'No department'}`
      ...
      desc={
        <div className='space-y-4'>
          <p className='mb-2'>
            ...
            <br />
            This doctor specializes in <span className='font-bold'>{doctorInfo}</span>.
            <br />
            This action will permanently remove the doctor with role(s) of{' '}
